...
const Home = () => {
  ...
  return (
    ...
    >
<div ref={ref} className="w-full h-screen flex  items-center justify-center  overflow-hidden  xl:justify-end -mt-32 sm:-mt-24 lg:-mt-16">
      <motion.div
      className="relative w-[350px] h-[330px] sm:w-[380px] sm:h-[360px] md:w-[400px] md:h-[380px] lg:w-[450px] lg:h-[430px]  xl:h-[440px] xl:w-[500px] overflow-visible bg-gray-200 rounded-3xl xl:mr-28 "
      >
        <motion.img
    ...
    <div className="flex flex-col-reverse xl:flex-row xl:items-center xl:justify-between     xl:ml-9  -mt-[10rem] lg:-mt-[8rem] md:-mt-[7rem] sm:-mt-[8rem]">
   
        <div className="flex flex-col items-center text-center justify-center   xl:absolute xl:top-[8rem] ">
